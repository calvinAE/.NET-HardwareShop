...
namespace HardwareShop.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ProductCategoriesController(HardwareShopDbContext context)
        {
            _context = context;
        }
        ...
        {
            var categories = from p in _context.ProductCategory
                            select p;

            int pageSize = 3;
            // return View(hardwareShopDbContext.ToString());
            return View(await PaginatedList<ProductCategory>.CreateAsync(categories.AsNoTracking(), pageNumber ?? 1, pageSize));
        }
